Simple webapp to easily copy texts with one click.  
Can be used as a tab on your laptop, or enable clipboard sync between your phone and laptop, then use on the phone to quickly change the laptop clipboard without having to leave your current window.   
